...
typedef enum {STARTTOKEN,
              NUM,              // integer literal
              // TODO: add more here
              PLUS, MINUS, MULT, DIV, NOT, LESS, GREATER, LE, GE, AND, OR, // operators
              SEMICOLON, COMMA, LPAREN, RPAREN, LBRACK, RBRACK, LBRACE, RBRACE, // punctuation
              ASSIGN, EQ, NOTEQ, // assignment and equality
              INT, CHAR,         // types
              IF, ELSE, WHILE, BREAK, RETURN, READ, WRITE, WRITELN, // keywords
              ID,               //identifiers
...
//                           "FACT", "LESS", "GREATER", "LE", "GE", "AND", "OR",
